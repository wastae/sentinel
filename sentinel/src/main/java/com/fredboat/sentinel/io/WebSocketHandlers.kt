...
class WebSocketHandlers(
    ...
    fun consume(context: SocketContext, request: JSONObject) {
        ...
        when (request.getString("eventType")) {
            ...
            SendSlashRequest::class.java.simpleName -> message.consume(context.gson.fromJson(`object`, SendSlashRequest::class.java), context)
            ...
            EditSlashRequest::class.java.simpleName -> message.consume(context.gson.fromJson(`object`, EditSlashRequest::class.java))
